...
import { setDocument, resetDocument, setBrandPalettes } from './documents/editor/EditorContext';
...
export { App, setDocument, resetDocument, setBrandPalettes, remapColors, render, isRendered, DEFAULT_SOURCE };
