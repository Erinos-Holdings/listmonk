...
type Queries struct {
	...
	GetCampaignListNames *sqlx.Stmt `query:"get-campaign-list-names"`
	...
	GetEvergreenSentSplit      *sqlx.Stmt `query:"get-evergreen-sent-split"`
	...
	// Fork (media tags) -- MEDIA-TAGS-SPEC 3.3.
